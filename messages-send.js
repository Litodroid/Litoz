...
const makeMessagesSocket = (config) => {
    ...
    return {
        ...
        sendMessage: async (jid, content, options = {}) => {
            ...
            // Verificar si este mensaje ya está siendo procesado
            if (messageProcessCache.get(messageId)) {
                logger.debug({ messageId }, 'Message already being processed, skipping duplicate');
            ...
            messageProcessCache.set(messageId, true);
            ...
            try {
                ...
                if (typeof content === 'object' && 'album' in content && content.album) {
                    ...
                    const fullMsg = await (0, Utils_1.generateWAMessage)(jid, content, {
                        ...
                        messageId: messageId, // Usar el messageId generado
                        ...options,
                    });
                    ...
                    try {
                        ...
                        messageProcessCache.del(messageId);
                        throw error;
                    }
                }
            } catch (error) {
